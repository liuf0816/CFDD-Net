...
class HSH_UNet(nn.Module):
    ...
    def __init__(self, num_classes=2, input_channels=3, gnconv=gnconv, block=Block,
                 pretrained=None,
...
if __name__ =="__main__":
    a = torch.rand(4,3,256,320)
    net = HSH_UNet()
    b = net(a)
    print(b.size())
    summary(net, input_size=(1,3, 256, 320))